...
Em linguagens de programação como Java, ao declararmos atributos privados nas classes, costumamos a criar métodos
...
# Refatorando a classe de forma Pythônica, com @property (propriedades)
